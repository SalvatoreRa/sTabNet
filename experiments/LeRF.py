...
for f in range(90):
        ...
        ind_imp = feat_impor.index[np.argmin(feat_impor.mean_f)]
        ...
        results.to_csv(res_dir+ 'results_XGBoost_inf+LeRF' +'.csv')  
...
for f in range(90):
        ...
        results.to_csv(res_dir+ 'results_pnet_inf+LeRF' +'.csv')
